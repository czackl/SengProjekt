...
class TetrisApp(object):
    ...
    def run(self):
                ...
                while 1:
                    ...
                    if self.gameover:
                        self.center_msg("Du hast verloren D: Bitte druecke Space um fortzufahren")

                    else:
                        if self.paused:
                            self.center_msg("Dies ist das wunderschoene Pausenmenue. Bitte geniesse deinen Aufenthalt")
